...
| 2.12 Modal And Optional Choices | partial; Brainstorm now has explicit hand-to-library-top ordering, Fact or Fiction has `/play` pile selection, and Ward has `/play` pay/decline choice handling, but broad modal/optional choice UI is still incomplete |
